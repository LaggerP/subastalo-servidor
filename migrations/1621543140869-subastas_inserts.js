...
(CONVERT (DATE, DATEADD(HOUR, -3, GETDATE())), CONVERT (TIME, DATEADD(HOUR, -3, GETDATE())), 'abierta', 1, 1, 1000, 'si', 'si', 'Oro'),
(DATEADD(day, 15, GETDATE()), '14:00:00', 'abierta', 1, 1, 1000, 'si', 'si', 'Comun'),
(CONVERT (DATE, DATEADD(HOUR, -3, GETDATE())), CONVERT (TIME, DATEADD(HOUR, -3, GETDATE())), 'abierta', 1, '1', 1000, 'si', 'si', 'Platino'),
